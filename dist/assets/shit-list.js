...
define("shit-list/templates/components/forgive-person", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "B7NImJVM", "block": "{\"statements\":[[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"forgive-button\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"forgive\",[\"get\",[\"model\"]]]],[\"flush-element\"],[\"text\",\"Forgive\"],[\"close-element\"],[\"text\",\"\\n\"],[\"yield\",\"default\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "shit-list/templates/components/forgive-person.hbs" } });
});
...
define("shit-list/templates/components/people-stats", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "vWT/1Vzj", "block": "{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"All: \"],[\"append\",[\"unknown\",[\"people\",\"length\"]],false],[\"close-element\"],[\"text\",\"\\n\"],[\"yield\",\"default\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "shit-list/templates/components/people-stats.hbs" } });
});
